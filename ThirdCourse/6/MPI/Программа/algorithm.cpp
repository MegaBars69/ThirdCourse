...
void FirstStep(Args *a)
{
    ...
    int K = a->k;
    int rows = a->rows;
    int block_size_row = m, block_size_col, size = a->s, down_block_size_row, down_block_size_col;
...
{
    double* A = aA->A, *B = aA->B, *U = aA->U, *ProductResult = aA->Pro;
    double norm = aA->norm;
