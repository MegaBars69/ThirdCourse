...
void ApplyMatrixToPairPrevSlow(double* U, double* Up, double* Down, int col_size, int row_size, int amount_of_vectors, bool down_is_zero = false, bool down_is_triungle = false);
